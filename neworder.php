...
<html lang="en" class="no-js">
	...
	<body>
		...
		<section class="features-list" id="neworder">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<div class="overlay overlay-boxify">
			<nav>
				<ul>
					...
					<li><a href="#neworder"><i class="fa fa-flash"></i>Features</a></li>
				</ul>
				<ul>
					<li><a href="#orders"><i class="fa fa-desktop"></i>Screenshots</a></li>
