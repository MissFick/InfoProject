	...
	<h1> Storage Order Form </h1>
		<div id="">
			...
			<?php
				...
				$result = mysql_query("SELECT * FROM storage_type where storage_id='1'");
				$row= mysql_fetch_array($result);
			?>
				  <h1>Request for Shelf Storage</h1>
                    <form method="post" action="invoice.php" >
					<table width="500">
						<tr><td><label>Number Of Storage Units Available</label></td><td> <?php echo $row["storage_available"]; ?></td></tr>
